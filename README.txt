...
a persistence unit "webappPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "webapp/pom.xml":
...
artifact ("webapp.war") is already built. You can build
